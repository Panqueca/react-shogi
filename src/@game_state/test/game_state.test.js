        ...
        squares: [
          {
            ...
            x: 0,
            y: 0,
            piece: { id: 1, player_number: 2, selected: false, type: "Lance" }
          },
          {
            id: "81",
            x: 1,
            y: 0,
            piece: { id: 2, player_number: 2, selected: false, type: "Knight" }
          }
        ],
        hands: [
          { player_number: 1, pieces: [] },
          ...
          hands: [
            {
              player_number: 1,
              pieces: [
                { id: 3, player_number: 1, selected: true, type: "Pawn" }
              ]
            },
            { player_number: 2, pieces: [] }
          ]
      ...
      it("returns the piece", () => {
        let gameState = new GameState({
          ...
          hands: [
            {
              player_number: 1,
              pieces: [{ id: 3, player_number: 1, type: "Pawn" }]
            },
            { player_number: 2, pieces: [] }
          ]
        });
    ...
    describe("when to is occupied", () => {
      it("must return to", () => {
        let gameState = new GameState({
          ...
          squares: [
            ...
            },
            {
              ...
              x: 1,
              y: 0,
              piece: { id: 2, player_number: 2, selected: false, type: "" }
            }
          ],
          hands: [
            { player_number: 1, pieces: [] },
        ...
        let from = new Square({
          ...
          x: 1,
          y: 0,
          piece: { id: 2, player_number: 1, selected: false, type: "Pawn" }
        });
        let to = new Square({
          id: "91",
          x: 0,
          y: 0,
          piece: { id: 1, player_number: 2, selected: false, type: "Pawn" }
        });
          ...
          squares: [
            {
              ...
              x: 0,
              y: 0,
              piece: { id: 1, player_number: 1, type: "KingGote" }
            },
            {
              id: "81",
              x: 1,
            ...
            { id: "92", x: 0, y: 1, piece: null },
            {
              ...
              x: 0,
              y: 2,
              piece: { id: 3, player_number: 2, type: "Rook" }
            }
          ],
          hands: [
            { player_number: 1, pieces: [] },
        ...
        let gameState = new GameState({
          ...
          squares: [
            ...
            { id: "92", x: 0, y: 1, piece: null },
            {
              ...
              x: 0,
              y: 2,
              piece: { id: 32, player_number: 1, type: "Pawn" }
            }
          ],
          hands: [
            { player_number: 1, pieces: [] },
  ...
  describe("nonKingPiecesCannotMove", () => {
    describe("non ou pieces have no destinations", () => {
      it("must return true", () => {
        ...
        let result = gameState.nonKingPiecesCannotMove(1);
  ...
  describe("KingCannotMove", () => {
    describe("ou has no destinations", () => {
      it("must return true", () => {
          ...
          squares: [
            {
              ...
              x: 0,
              y: 0,
              piece: { id: 4, player_number: 1, type: "KingGote" }
            },
            {
              id: "92",
              x: 0,
        ...
        let result = gameState.KingCannotMove(1);
        ...
        let gameState = new GameState({
          ...
          squares: [
            ...
            },
            {
              ...
              x: 2,
              y: 1,
              piece: { id: 12, player_number: 2, type: "KingSente" }
            }
          ],
          hands: [
            { player_number: 1, pieces: [] },
        ...
        let gameState = new GameState({
          ...
          squares: [
            ...
            },
            {
              ...
              x: 0,
              y: 1,
              piece: { id: 6, player_number: 1, type: "Rook" }
            },
...

            {
              ...
              x: 2,
              y: 0,
              piece: { id: 10, player_number: 2, type: "Pawn" }
            },
            {
              id: "72",
              x: 2,
    ...
    describe("piece is actually moving", () => {
      ...
      describe("and there is capture", () => {
        it("moves the piece and adds the captured piece to hand", () => {
          ...
          let newFrom = gameState.squares.findById("94");
          let newTo = gameState.squares.findById("93");
          let hand = gameState.hands.find(function(h) {
        ...
        let gameState = new GameState({
          ...
          squares: [
            ...
            },
            {
              ...
              x: 0,
              y: 3,
              piece: { id: 1, player_number: 1, type: "Pawn", selected: true }
            }
          ],
          hands: [
            { player_number: 1, pieces: [] },
          ...
          hands: [
            {
              player_number: 1,
              pieces: [
                { id: 7, player_number: 1, type: "Pawn", selected: false }
              ]
            },
            { player_number: 2, pieces: [] }
          ]
          ...
          hands: [
            {
              player_number: 1,
              pieces: [
                { id: 7, player_number: 1, type: "Pawn", selected: true }
              ]
            },
            { player_number: 2, pieces: [] }
          ]
  ...
  describe("promote", () => {
    describe("when piece is promotable", () => {
      it("must promote the piece", () => {
        ...
        expect(result).toBe(true);
        expect(square.piece.id).toEqual(1);
        expect(square.piece.constructor).toEqual(GoldGeneral);
      });
    });
        ...
        let gameState = new GameState({
          ...
          squares: [
            ...
            },
            {
              ...
              x: 0,
              y: 3,
              piece: { id: 1, player_number: 1, type: "GoldGeneral" }
            }
          ],
          hands: [
            { player_number: 1, pieces: [] },
    ...
    describe("when square does not exist", () => {
      it("must return false", () => {
        ...
        expect(result).toBe(false);
        expect(square_a.piece.constructor).toEqual(Pawn);
        expect(square_b.piece.constructor).toEqual(Pawn);
      });
    });
  });
