...
describe("DragonHorse", () => {
  describe("destinations", () => {
    it("must return only valid destinations", () => {
      let DragonHorse = new DragonHorse({
        id: 17,
        player_number: 1,
        type: "DragonHorse"
      });
      let origin = new Square({ id: "88", x: 1, y: 7, piece: DragonHorse });
      ...
      let result = DragonHorse.destinations(origin, gameState);
    ...
    it("must not return occupied by player squares", () => {
      ...
      let forward = new Square({
        ...
        x: 1,
        y: 6,
        piece: { id: 10, player_number: 1, type: "Pawn" }
      });
      let far = new Square({
        id: "86",
        x: 1,
